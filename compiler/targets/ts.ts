...
- To take an effect back (\`undo @pay.charge\`): the call is \`{ undo: "pay.charge", answer: <the answer the original call got> }\`, with \`args\` too when the undo's binding reads the original params. The reply is the \`…Answered\` message of the endpoint the contract names in \`undone by\`.

...
|---|---|---|---|---|---|---|---|---|---|
| Helpdesk | 6/6 | 0/6 | 6/6 | 100% | 100% | 100% | 100% | 69% / 55% | $4.87 |
...
|---|---|---|---|---|
| Helpdesk | 6/6 | 2.1% / 2.6% / 2.3% | 93% / 58% / 74% | 4 / 9 / 6 |
...
- elm-1 first problem: 47 screens match
- elm-2 first problem: 47 screens match
- elm-3 first problem: 47 screens match
- ts-1 first problem: 47 screens match
- ts-2 first problem: 47 screens match
- ts-3 first problem: 47 screens match

Contact sheets: `r6-styled/10-helpdesk/sheets/`

// Platform std.crypto (lib/std/crypto.intent): reviewed code the harness provides, never the LLM.
// Pure and synchronous, with no Node or browser APIs, so every target can use the same code.
